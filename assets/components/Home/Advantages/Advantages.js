...
const info = [
  {
    ...
    info:
      "Приложението е направено удобно за потребителя, като само с един клик на мишката се генерира уникален код за местността, която е посочил на Google Maps картата.",
  },
  {
